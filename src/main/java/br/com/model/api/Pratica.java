...
public class Pratica {
	...
	public static Pratica jsonToPratica(String json){
		return new Gson().fromJson(json, Pratica.class);
	}

	public static String praticaToJson(Pratica pratica){
		return new Gson().toJson(pratica);
	}
}
